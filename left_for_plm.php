...
$edge=new ComponentFilesInfo(0,"edge","","$edgeRows","$edgeTotal",$edgeList,$edgeIconsList);
...
$eyelet=new ComponentFilesInfo(1,"eyelet","","$eyeletRows","$eyeletTotal",$eyeletList,$eyeletIconsList);
...
$lace=new ComponentFilesInfo(2,"lace","","$laceRows","$laceTotal",$laceList,$laceIconsList);
...
$quarters=new ComponentFilesInfo(3,"quarters","","$quartersRows","$quartersTotal",$quartersList,$quartersIconsList);
...
$tongue=new ComponentFilesInfo(5,"tongue","","$tongueRows","$tongueTotal",$tongueList,$tongueIconsList);
